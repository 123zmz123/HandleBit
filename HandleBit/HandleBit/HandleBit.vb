Public Class HandleBit
    ...
    Public Shared Function SetBitsInRange(ByRef val As Byte, ByVal startBit As Integer, ByVal endBit As Integer)

    End Function
    Public Shared Function SetBitsInRange(ByRef val As Byte, ByVal mask As String)
